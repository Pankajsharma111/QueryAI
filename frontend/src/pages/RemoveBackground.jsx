  ...
  return (
    <div className='h-full  overflow-y-scroll p-6 flex items-start flex-wrap gap-4 text-slate-700'>
        {/* Left col */}
          ...
          <button disabled={loading} className='w-full flex justify-center items-center gap-2 bg-gradient-to-r from-[#f6ab49] to-[#ff4938] text-white px-4 py-2 mt-6 mb-3 text-sm rounded-lg cursor-pointer'>
            {
      ...
      {/* Right col */}
        <div className='w-full max-w-lg p-4 bg-white rounded-lg flex flex-col border border-gray-200 min-h-100 '>
              ...
              <div className='flex-1 flex  justify-center items-center'>
                ...
                className='w-full flex justify-center items-center gap-2 bg-gradient-to-r from-[#f6ab49] to-[#ff4938] text-white px-4 py-2 mt-6 mb-3 text-sm rounded-lg cursor-pointer'
              >
